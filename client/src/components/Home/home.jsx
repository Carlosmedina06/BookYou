...
export const Home = () => {
  ...
  const [books, setBooks] =
    useState(true); /* actualizar estado libros orden alf */
  const [bookInput, setBookInput] =
    useState(''); /* actualizar estado searchbar por libro*/
  const [authorInput, setAuthorInput] =
    useState(''); /* actualizar estado searchbar por autor */
  const [bookInputtodos, setBookInputtodos] =
    useState(
      ''
    ); /* actualizar estado genero 'value=todos' para serachbar por libro y autor*/
    ...
    setFilterLibros(
      allBooks.filter(b => {
        if (
          ...
          return b.category
            .toLowerCase()
            .includes(bookInputtodos.toLowerCase());
