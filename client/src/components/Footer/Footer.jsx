      ...
      <div className={styles.membersContainer}>
        ...
        <div className={styles.developerBox}>
          ...
          <div className={styles.devData}>
            <p>Vanesa Cignani</p>
            <a href="https://github.com/88Vane88" target="_blank">
              <svg
        ...
        <div className={styles.developerBox}>
          ...
          <div className={styles.devData}>
            ...
            <a href="https://github.com/Loner05" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 64 64"
                width="35px"
            ...
            <a
              href="https://www.linkedin.com/in/juanfelipevel/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className={styles.developerBox}>
          ...
          <div className={styles.devData}>
            <p>Carlos Medina</p>
            <a href="https://github.com/Carlosmedina06" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 64 64"
                width="35px"
            ...
            <a href="https://linkedin.com/in/carlosmedina06" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                width="35px"
        ...
        <div className={styles.developerBox}>
          ...
          <div className={styles.devData}>
            <p>Dario Salvadore</p>
            <a href="https://github.com/DarioGabrielS" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 64 64"
                width="35px"
        ...
        <div className={styles.developerBox}>
          ...
          <div className={styles.devData}>
            ...
            <a href="https://github.com/Andresrodp" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 64 64"
                width="35px"
