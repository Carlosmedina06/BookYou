...
<div className={style.flexContainer} >
            ...
            <div className={style.mainContent}>
          {
            (select === "stadistics" || select=== "home") &&
              <div className={style.homeHeaderGraphscontainer}>
                <div className={style.ContainerTitle}><h2>Estadisticas</h2></div>
                  ...
                  <div className={style.graphCard}> 
                    ...
                    <div className={style.graph}> <GraphicBooksFreeToSubs/></div>
                  ...
                  <div className={style.graphCard}> 
                    ...
                    {/* <img src="https://res.cloudinary.com/dn8jxsqka/image/upload/v1674958273/grafica_3_ghpcmm.png" alt="" /> */}
                    <div className={style.graph}><GraphicUsersFreeToSubs/></div>
                    <div className={style.cardTitle}> Usuarios  </div>
                  </div>
                  <div className={style.graphCard}> 
                    {/* <img src="https://res.cloudinary.com/dn8jxsqka/image/upload/v1674958273/grafica_3_ghpcmm.png" alt="" /> */}
                    <div className={style.graph}> <GraphicCommentsQuantity/></div>
         ...
         { 
          ...
          <div className={style.bookContainer}>
            <div className={style.ContainerTitle}><h2>Libros</h2></div>
          <div className={style.bookEditForm}><BookEdit /> </div>
             </div>
        }
          </div>
